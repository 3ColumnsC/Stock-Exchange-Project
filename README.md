Stock Exchange Project (SEP)

Current Version: 1.2: Control Panel updated, log messages improved, assets updated, 24/7 activity enabled, additional changes. (14/06/2025)

Old Versions: 1.1 Control Panel added, bugs fixed, assets fast control added, log messages improved, additional changes.
...
This project is a Node.js-based alert system that monitors price changes and news for a custom list of stocks, ETFs, and cryptocurrencies.
...
- 📆 Scheduled to run every 5–10 minutes using `node-cron`
...
4. Start the system with `npm start` or `electron .`
